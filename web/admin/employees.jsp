...
<html>
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500&family=Syne:wght@600;700;800&display=swap" rel="stylesheet">
            ...
            <main class="main">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-sub">Manage your active workforce</p>
                    </div>
                    <div class="header-actions">
                        <button class="btn"><i class="ti ti-download"></i> Export</button>
                        <button class="btn"><i class="ti ti-adjustments-horizontal"></i> Filter</button>
                        <a class="btn btn-primary" href="addEmployee.jsp"><i class="ti ti-plus"></i> Add employee</a>
                    </div>
                </div>
