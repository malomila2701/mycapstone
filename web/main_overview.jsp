            ...
            <div class="header-right">
                <div class="header_btn">
                    ...
                    <button class="header_icon" style="margin-right: 5px; border: 2px solid #ccc">
                        <span class="label" style="margin-left: 7px; margin-right: 5px;">Déconnexion</span>
                ...
                <div class="banner" id="latest_banner">
                    ...
                    <table class ="reqtable" cellspacing="0" id ="latest_b">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="display: flex; padding-left: 25px; justify-content: space-between; align-items: center; padding: 10px; gap: 15px;">
