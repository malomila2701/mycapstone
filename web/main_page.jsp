    ...
    <body>
        ...
        <div class="layout">
            <aside class="sidebar">
                ...
                <button class="tab" id="historyTab" onclick="loadPage('main_history.jsp', this)" data-url="main_history.jsp">
                ...
                %>
                <button class="tab" onclick="loadPage('admin/admin_section.jsp', this)" data-url="admin/admin_section.jsp" <%= ("admin".equals(role) || "manager".equals(role)) || "HR".equals(role) ? "" : "disabled" %>>
                    <span class="icon-home"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
